              ...
              <div className="overflow-y-auto space-y-1">
                {availableUsers.map((user) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2.5 rounded-xl hover:bg-gray-50 border border-transparent hover:border-gray-200 transition disabled:opacity-50 cursor-pointer"
                  >
