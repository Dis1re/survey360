              ...
              {templates.map((t) => (
                ...
                >
                  <button
                    ...
                    className="absolute top-2.5 right-2.5 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-red-500 transition cursor-pointer p-1"
                  ...
                  <button
                    ...
                    className="absolute top-2.5 right-8 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-gray-600 transition cursor-pointer p-1"
