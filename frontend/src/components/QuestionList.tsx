      ...
      {readOnly ? (
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-2">
          <input
            ...
            className="w-full border border-gray-200 dark:border-[#3a4250] rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-blue-500 dark:focus:border-[#FF8600]"
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={creating}
              className="px-3 py-1.5 text-sm font-medium text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-200 rounded-lg transition cursor-pointer"
            >
              Отмена
            </button>
          </div>
        ...
        <button
          ...
          className="mt-4 w-full py-2 border-2 border-dashed border-gray-200 dark:border-[#3a4250] hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 text-gray-500 dark:text-gray-300 text-sm font-medium rounded-xl soft-press flex items-center justify-center gap-1 cursor-pointer"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
